...
class ProductProvider extends ChangeNotifier {
  ...
  ProductProvider() {
    ...
    final List<dynamic> productListData = json.decode(jsonData);
    _products = productListData.map((json) => Product.fromJson(json)).toList();
    // _products = productFromJson(jsonDecode(jsonData));
  }

  List<Product> get products => _products;

  void toggleFavorite(Product product) {
    final index = _products.indexWhere((p) => p.title == product.title);
    if (index != -1) {
